...
from malnutrition.sms.views.malnutrition_reporting import MalnutritionReportBase
...
class MalnutritionReport(MalnutritionReportBase):
    @authenticated
    def post_init(self):
        MalnutritionReportBase.post_init(self) 
